...
// which to-mp4 carries into the MP4 movie metadata (see buildMovieMeta).
func globalTags(c *mkv.Container) []mkv.SimpleTag {
	var out []mkv.SimpleTag
	for _, t := range c.Tags {
		if t.TargetID == 0 {
			out = append(out, t.SimpleTags...)
		}
	}
	return out
}
