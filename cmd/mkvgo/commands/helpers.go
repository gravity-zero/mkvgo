...
var CmdUsage = map[string]string{
	...
	"to-hls":             "mkvgo to-hls <input.mkv> -o <dir> [-segment 6] [--keep-tracks 1,2] (fragmented-MP4 HLS; --keep-tracks = virtual track subset)",
	"hls-segment":        "mkvgo hls-segment <input.mkv|url> <master|playlist|init|N|resource-name> [-o out] [-segment 6] [--keep-tracks 1,2] (build one HLS resource on demand)",
