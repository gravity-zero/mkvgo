...
var CmdUsage = map[string]string{
	...
	"to-hls":             "mkvgo to-hls <input.mkv> -o <dir> [-segment 6] [--keep-tracks 1,2 | --keep-lang fre] [--sub-offset ms] (fragmented-MP4 HLS; virtual track subset by ID or language; virtual subtitle resync)",
	"hls-segment":        "mkvgo hls-segment <input.mkv|url> <master|playlist|init|N|resource-name> [-o out] [-segment 6] [--keep-tracks 1,2 | --keep-lang fre] [--sub-offset ms] (build one HLS resource on demand)",
	"to-abr":             "mkvgo to-abr -o <dir> <best.mkv> <lower.mkv> [...] [-segment 6] [--keep-tracks 1,2 | --keep-lang fre] [--sub-offset ms] (multi-variant HLS master from pre-encoded qualities)",
	"abr-segment":        "mkvgo abr-segment <master.m3u8|v{k}/name> <best> <lower> [...] [-o out] [-segment 6] [--keep-tracks 1,2 | --keep-lang fre] [--sub-offset ms] (build one ABR resource on demand)",
