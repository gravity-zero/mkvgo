...
var CmdUsage = map[string]string{
	...
	"to-hls":             "mkvgo to-hls <input.mkv> -o <dir> [-segment 6] [--keep-tracks 1,2 | --keep-lang fre] [--sub-offset ms] [--chapter-markers] (fragmented-MP4 HLS; virtual track subset by ID or language; virtual subtitle resync; opt-in chapter/ad-insertion markers)",
