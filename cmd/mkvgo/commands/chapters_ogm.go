...
// file (CHAPTER01=00:00:00.000 / CHAPTER01NAME=Intro - the standard chapter interchange format).
...
// stdout or to -o <file> - ready for set-chapters and other chapter-aware tools.
